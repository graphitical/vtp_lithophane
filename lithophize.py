...
def create_parser() -> argparse.ArgumentParser:
    ...
    vtp_params.add_argument('--v-star-hd', type=float, default=0.15,
    ...
    vtp_params.add_argument('--h-star-hd', type=float, default=6.93,
                            help='H* value for high density (dark areas)')
    vtp_params.add_argument('--h-star-ld', type=float, default=14.81,
    ...
    physical.add_argument('--line-spacing', type=float, default=1.2,
    ...
    physical.add_argument('--layer-height', type=float, default=1.27, dest='dz_mm',
